...
import { ABOUT_US_CONSTANTS } from "@/constants/about-us-constants";
  ...
  return (
    <section className="relative pt-44 pb-32 px-6 md:px-12 lg:px-24 overflow-hidden bg-palette-1 min-h-[600px] flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-l from-palette-1/80 to-transparent"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 flex flex-col items-center text-center">
        ...
        >
          <Link href="/" className="hover:text-white transition-colors flex items-center gap-1">
            {ABOUT_US_CONSTANTS.HERO.BREADCRUMB_HOME}
          </Link>
          <ChevronRight size={14} />
          <span className="text-white font-bold">{ABOUT_US_CONSTANTS.HERO.BREADCRUMB_ABOUT}</span>
        </motion.div>
        ...
        >
          {ABOUT_US_CONSTANTS.HERO.TITLE_PART_1} <br className="hidden md:block" />
          <span className="text-palette-3">{ABOUT_US_CONSTANTS.HERO.TITLE_PART_2}</span>
        </motion.h1>
        ...
        >
          {ABOUT_US_CONSTANTS.HERO.DESCRIPTION}
        </motion.p>
        ...
        >
          <button className="flex items-center justify-center gap-2 bg-palette-3 hover:bg-[#8eb800] text-palette-1 px-8 py-4 rounded-full font-bold text-lg transition-all transform hover:scale-105 shadow-xl shadow-palette-3/30">
            <Users size={20} />
            {ABOUT_US_CONSTANTS.HERO.BUTTON_TEAM}
          </button>
          <button className="flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white backdrop-blur-sm border border-white/20 px-8 py-4 rounded-full font-bold text-lg transition-all">
            <BookOpen size={20} />
            {ABOUT_US_CONSTANTS.HERO.BUTTON_COURSES}
          </button>
        </motion.div>
