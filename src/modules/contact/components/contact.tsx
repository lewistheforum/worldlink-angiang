...
export default function Contact() {
  return (
    <>
      ...
      {/* Content Section */}
      <div className="relative z-10 bg-white py-16 md:py-20 px-4 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto bg-white rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col md:flex-row border border-gray-100">
          ...
          <div className="bg-palette-1 p-6 sm:p-10 md:p-14 md:w-2/5 flex flex-col relative overflow-hidden">
            {/* Decorative circles */}
          ...
          <div className="p-6 sm:p-10 md:p-14 md:w-3/5 bg-white">
