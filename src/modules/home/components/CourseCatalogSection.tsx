...
import { languagesData as languages, allCoursesData as allCourses } from "@/data/CourseCatalogData";
import { COURSE_CATALOG_CONSTANTS } from "@/constants/CourseCatalogConstants";
...
export default function CourseCatalogSection() {
  ...
  return (
    <section id="dao-tao-ngoai-ngu" className="py-24 px-6 md:px-12 lg:px-24 bg-slate-50 relative overflow-hidden">
      {/* Background Decor */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="inline-block bg-white px-4 py-2 rounded-full shadow-sm mb-4 border border-gray-100">
            <p className="text-sm font-bold text-palette-1 uppercase tracking-wider">{COURSE_CATALOG_CONSTANTS.SUBTITLE}</p>
          </div>
