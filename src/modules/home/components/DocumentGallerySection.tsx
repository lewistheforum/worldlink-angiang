...
import { documentsData as documents } from "@/data/DocumentGalleryData";
import { DOCUMENT_GALLERY_CONSTANTS } from "@/constants/DocumentGalleryConstants";
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <p className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-2">{DOCUMENT_GALLERY_CONSTANTS.SUBTITLE}</p>
            ...
            {selectedDoc && (
              <div className="relative flex flex-col items-center w-full">
                ...
                <Dialog.Description className="sr-only">
                  Bản xem trước đầy đủ của {selectedDoc.title}
                </Dialog.Description>
              </div>
            )}
          </Dialog.Content>
