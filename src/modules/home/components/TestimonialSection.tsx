...
import { feedbacksData as feedbacks } from "@/data/TestimonialData";
import { TESTIMONIAL_CONSTANTS } from "@/constants/TestimonialConstants";
...
export default function TestimonialSection() {
  ...
  return (
    <section className="py-24 px-6 md:px-12 lg:px-24 bg-palette-1 overflow-hidden">
      <div className="max-w-7xl mx-auto text-center mb-16">
        <p className="text-white/90 font-medium mb-2 uppercase tracking-wide text-sm">{TESTIMONIAL_CONSTANTS.SUBTITLE}</p>
