...
export default function LanguageTrainingHero() {
  return (
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 flex flex-col items-center text-center">
        ...
        >
          <Link href="/" className="hover:text-white transition-colors flex items-center gap-1">
            {LANGUAGE_TRAINING_CONSTANTS.HERO.BREADCRUMB_HOME}
          </Link>
          <ChevronRight size={14} />
          <span className="text-white font-bold">{LANGUAGE_TRAINING_CONSTANTS.HERO.BREADCRUMB_TRAINING}</span>
        </motion.div>
        ...
        >
          {LANGUAGE_TRAINING_CONSTANTS.HERO.TITLE_PART_1} <br className="hidden md:block" />
          <span className="text-palette-3">{LANGUAGE_TRAINING_CONSTANTS.HERO.TITLE_PART_2}</span>
        </motion.h1>
        ...
        >
          {LANGUAGE_TRAINING_CONSTANTS.HERO.DESCRIPTION}
        </motion.p>
        ...
        >
          <button className="flex items-center justify-center gap-2 bg-palette-3 hover:bg-[#8eb800] text-palette-1 px-8 py-4 rounded-full font-bold text-lg transition-all transform hover:scale-105 shadow-xl shadow-palette-3/30">
            <BookOpen size={20} />
            {LANGUAGE_TRAINING_CONSTANTS.HERO.BUTTON_COURSES}
          </button>
          <button className="flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white backdrop-blur-sm border border-white/20 px-8 py-4 rounded-full font-bold text-lg transition-all">
            <Globe2 size={20} />
            {LANGUAGE_TRAINING_CONSTANTS.HERO.BUTTON_TEST}
          </button>
        </motion.div>
