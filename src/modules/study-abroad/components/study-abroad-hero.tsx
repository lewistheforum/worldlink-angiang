      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 flex flex-col items-center text-center">
        ...
        >
          <Link href="/" className="hover:text-white transition-colors flex items-center gap-1">
            {STUDY_ABROAD_CONSTANTS.HERO.BREADCRUMB_HOME}
          </Link>
          <ChevronRight size={14} />
          <span className="text-white font-bold">{STUDY_ABROAD_CONSTANTS.HERO.BREADCRUMB_STUDY_ABROAD}</span>
        </motion.div>
        ...
        >
          {STUDY_ABROAD_CONSTANTS.HERO.DESCRIPTION}
        </motion.p>
